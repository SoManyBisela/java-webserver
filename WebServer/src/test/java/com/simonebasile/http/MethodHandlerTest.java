...
public class MethodHandlerTest {
    ...
    class TestMethodHandler extends MethodHandler<String, Object> {
        @Override
        protected HttpResponse<? extends HttpResponse.ResponseBody> handleGet(HttpRequest<? extends String> r, Object context) {
            return new HttpResponse<>(200, new HttpHeaders(), new ByteResponseBody("GET response"));
        }

        @Override
        protected HttpResponse<? extends HttpResponse.ResponseBody> handlePost(HttpRequest<? extends String> r, Object context) {
            return new HttpResponse<>(201, new HttpHeaders(), new ByteResponseBody("POST response"));
        }

        @Override
        protected HttpResponse<? extends HttpResponse.ResponseBody> handlePut(HttpRequest<? extends String> r, Object context) {
            return new HttpResponse<>(202, new HttpHeaders(), new ByteResponseBody("PUT response"));
        }

        @Override
        protected HttpResponse<? extends HttpResponse.ResponseBody> handleDelete(HttpRequest<? extends String> r, Object context) {
    ...
    public void testHandleGet() {
        ...
        HttpResponse<? extends HttpResponse.ResponseBody> response = handler.handle(request, new Object());
    ...
    public void testHandleMethodNotAllowed() {
        ...
        HttpResponse<? extends HttpResponse.ResponseBody> responseOptions = handler.handle(requestOptions, new Object());
        ...
        HttpResponse<? extends HttpResponse.ResponseBody> responsePatch = handler.handle(requestPatch, new Object());
        ...
        HttpResponse<? extends HttpResponse.ResponseBody> responseTrace = handler.handle(requestTrace, new Object());
        ...
        HttpResponse<? extends HttpResponse.ResponseBody> responseConnect = handler.handle(requestConnect, new Object());
