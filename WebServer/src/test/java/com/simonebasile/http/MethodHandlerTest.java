...
public class MethodHandlerTest {
    ...
    class TestMethodHandler extends MethodHandler<String, Object> {
        @Override
        protected HttpResponse<? extends ResponseBody> handleGet(HttpRequest<? extends String> r, Object context) {
            return new HttpResponse<>(200, new HttpHeaders(), new ByteResponseBody("GET response"));
        }

        @Override
        protected HttpResponse<? extends ResponseBody> handlePost(HttpRequest<? extends String> r, Object context) {
            return new HttpResponse<>(201, new HttpHeaders(), new ByteResponseBody("POST response"));
        }

        @Override
        protected HttpResponse<? extends ResponseBody> handlePut(HttpRequest<? extends String> r, Object context) {
            return new HttpResponse<>(202, new HttpHeaders(), new ByteResponseBody("PUT response"));
        }

        @Override
        protected HttpResponse<? extends ResponseBody> handleDelete(HttpRequest<? extends String> r, Object context) {
    ...
    public void testHandleGet() {
        ...
        HttpResponse<? extends ResponseBody> response = handler.handle(request, new Object());
    ...
    public void testHandleMethodNotAllowed() {
        ...
        HttpResponse<? extends ResponseBody> responseOptions = handler.handle(requestOptions, new Object());
        ...
        HttpResponse<? extends ResponseBody> responsePatch = handler.handle(requestPatch, new Object());
        ...
        HttpResponse<? extends ResponseBody> responseTrace = handler.handle(requestTrace, new Object());
        ...
        HttpResponse<? extends ResponseBody> responseConnect = handler.handle(requestConnect, new Object());
